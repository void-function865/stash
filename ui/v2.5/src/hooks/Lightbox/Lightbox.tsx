...
export const LightboxComponent: React.FC<IProps> = ({
  ...
  useEffect(() => {
    // Don't auto-close while images are still loading. Some entry points (the
    // gallery lightbox) open with an empty image list and isLoading=true, then
    // populate it asynchronously. Only an empty list *after* loading means the
